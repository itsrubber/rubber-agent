...
class TestLoadGatewayConfig:
    ...
    def test_bridges_whatsapp_sync_full_history_from_config_yaml(self, tmp_path, monkeypatch):
        hermes_home = tmp_path / ".hermes"
        hermes_home.mkdir()
        config_path = hermes_home / "config.yaml"
        config_path.write_text(
        ...
        assert config.platforms[Platform.WHATSAPP].extra["sync_full_history"] is True
